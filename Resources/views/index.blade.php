...
@section('title', config('chat.name'))

@section('page-style')
<!-- Page css files -->
  <link rel="stylesheet" href="{{ mix('css/chat.css') }}">
  <link rel="stylesheet" href="{{ mix('css/chatList.css') }}">
      ...
      <header class="chat-header">
        <div class="d-flex align-items-center">
          ...
          <div class="avatar avatar-border user-profile-toggle m-0 mr-1">
            <img src="{{ asset('themes/girisoft/images/portrait/small/avatar-s-7.jpg') }}" alt="avatar" height="36" width="36" />
  ...
  <header class="user-profile-header">
    ...
    <div class="header-profile-sidebar">
      <div class="avatar box-shadow-1 avatar-border avatar-xl">
        <img src="{{ asset('themes/girisoft/images/portrait/small/avatar-s-7.jpg') }}" alt="user_avatar" height="70" width="70" />
