  ...
  <header class="chat-profile-header">
    ...
    <div class="header-profile-sidebar">
      <div class="avatar box-shadow-1 avatar-xl avatar-border">
        <img src="{{ asset('themes/girisoft/images/portrait/small/avatar-s-11.jpg') }}" alt="user_avatar" />
...
<div class="sidebar-content card">
    ...
    <div class="d-flex align-items-center w-100">
      <div class="sidebar-profile-toggle">
        <div class="avatar avatar-border">
          <img src="{{ asset('themes/girisoft/images/portrait/small/avatar-s-11.jpg') }}" alt="user_avatar" height="42" width="42" />
  ...
  <div id="users-list" class="chat-user-list-wrapper list-group">
    ...
    <ul class="chat-users-list chat-list media-list">
      <li>
        <span class="avatar"><img src="{{ asset('themes/girisoft/images/portrait/small/avatar-s-3.jpg') }}" height="42" width="42" alt="Generic placeholder image" />
      ...
      <li>
        <span class="avatar"><img src="{{ asset('themes/girisoft/images/portrait/small/avatar-s-7.jpg') }}" height="42" width="42" alt="Generic placeholder image" />
      ...
      <li>
        <span class="avatar"><img src="{{ asset('themes/girisoft/images/portrait/small/avatar-s-8.jpg') }}" height="42" width="42" alt="Generic placeholder image" />
    ...
    <ul class="chat-users-list contact-list media-list">
      ...
      <li>
        <span class="avatar"><img src="{{ asset('themes/girisoft/images/portrait/small/avatar-s-5.jpg') }}" height="42" width="42" alt="Generic placeholder image" />
        </span>
        <div class="chat-info">
      ...
      <li>
        <span class="avatar"><img src="{{ asset('themes/girisoft/images/portrait/small/avatar-s-9.jpg') }}" height="42" width="42" alt="Generic placeholder image" />
        </span>
        <div class="chat-info">
      ...
      <li>
        <span class="avatar"><img src="{{ asset('themes/girisoft/images/portrait/small/avatar-s-15.jpg') }}" height="42" width="42" alt="Generic placeholder image" />
        </span>
        <div class="chat-info">
          <h5 class="mb-0">Kristopher Candy</h5>
          <p class="card-text text-truncate">
      ...
      <li>
        <span class="avatar"><img src="{{ asset('themes/girisoft/images/portrait/small/avatar-s-14.jpg') }}" height="42" width="42" alt="Generic placeholder image" />
        </span>
        <div class="chat-info">
      ...
      <li>
        <span class="avatar"><img src="{{ asset('themes/girisoft/images/portrait/small/avatar-s-17.jpg') }}" height="42" width="42" alt="Generic placeholder image" />
        </span>
        <div class="chat-info">
      ...
      <li>
        <span class="avatar"><img src="{{ asset('themes/girisoft/images/portrait/small/avatar-s-13.jpg') }}" height="42" width="42" alt="Generic placeholder image" />
        </span>
        <div class="chat-info">
